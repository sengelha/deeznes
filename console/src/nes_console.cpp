...
std::ostream &operator<<(std::ostream &os, const nes_console &console) {
    ...
    case m6502_addrmode::ABX: {
        ...
        os << "$" << hex << uppercase << setw(4) << setfill('0') << (int)addr
           << ",X @ " << hex << uppercase << setw(4) << setfill('0')
           << (int)addr2 << " = " << hex << uppercase << setw(2) << setfill('0')
           << (int)val << "        ";
        break;
    }
    case m6502_addrmode::ABY: {
        ...
        uint8_t val = console.cpu_binder_.readu8(addr2);
        os << "$" << hex << uppercase << setw(4) << setfill('0') << (int)addr
           << ",Y @ " << hex << uppercase << setw(4) << setfill('0')
           << (int)addr2 << " = " << hex << uppercase << setw(2) << setfill('0')
           << (int)val << "        ";
        break;
    }
    ...
    case m6502_addrmode::IXX: {
        ...
        os << "($" << (int)instr.bytes[1] << ",X) @ " << (int)addend << " = "
    ...
    case m6502_addrmode::IXY: {
        ...
        os << "($" << (int)instr.bytes[1] << "),Y = " << hex << uppercase
           << setw(4) << setfill('0') << (int)val1 << " @ " << hex << uppercase
           << setw(4) << setfill('0') << (int)val2 << " = " << hex << uppercase
           << setw(2) << setfill('0') << (int)val3 << " ";
        break;
    }
    ...
    os << " "
       ...
       << "CYC:" << dec << setw(3) << setfill(' ')
       << (int)state.ppu_state.cycles << " "
