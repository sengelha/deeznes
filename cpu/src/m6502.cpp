...
uint_fast32_t m6502::run(uint_fast32_t maxcycles) {
  ...
  static constexpr void *dispatch_table[] = {
      &&brkimp, &&oraixx, &&nopimp, &&sloixx,
      &&nopzpg, &&orazpg, &&aslzpg, &&slozpg, // $00-$07
      &&phpimp, &&oraimm, &&aslacc, &&nopimp,
      &&nopabs, &&oraabs, &&aslabs, &&sloabs, // $08-$0F
      &&bplrel, &&oraixy, &&nopimp, &&sloixy,
      &&nopzpx, &&orazpx, &&aslzpx, &&slozpx, // $10-$17
      &&clcimp, &&oraaby, &&nopimp, &&sloaby,
      &&nopabx, &&oraabx, &&aslabx, &&sloabx, // $18-$1F
      &&jsrabs, &&andixx, &&nopimp, &&rlaixx,
      &&bitzpg, &&andzpg, &&rolzpg, &&rlazpg, // $20-$27
      &&plpimp, &&andimm, &&rolacc, &&nopimp,
      &&bitabs, &&andabs, &&rolabs, &&rlaabs, // $28-$2F
      &&bmirel, &&andixy, &&nopimp, &&rlaixy,
      &&nopzpx, &&andzpx, &&rolzpx, &&rlazpx, // $30-$37
      &&secimp, &&andaby, &&nopimp, &&rlaaby,
      &&nopabx, &&andabx, &&rolabx, &&rlaabx, // $38-$3F
      &&rtiimp, &&eorixx, &&nopimp, &&sreixx,
      &&nopzpg, &&eorzpg, &&lsrzpg, &&srezpg, // $40-$47
      &&phaimp, &&eorimm, &&lsracc, &&nopimp,
      &&jmpabs, &&eorabs, &&lsrabs, &&sreabs, // $48-$4F
      &&bvcrel, &&eorixy, &&nopimp, &&sreixy,
      &&nopzpx, &&eorzpx, &&lsrzpx, &&srezpx, // $50-$57
      &&cliimp, &&eoraby, &&nopimp, &&sreaby,
      &&nopabx, &&eorabx, &&lsrabx, &&sreabx, // $58-$5F
      &&rtsimp, &&adcixx, &&nopimp, &&rraixx,
      &&nopzpg, &&adczpg, &&rorzpg, &&rrazpg, // $60-$67
      &&plaimp, &&adcimm, &&roracc, &&nopimp,
      &&jmpind, &&adcabs, &&rorabs, &&rraabs, // $68-$6F
      &&bvsrel, &&adcixy, &&nopimp, &&rraixy,
      &&nopzpx, &&adczpx, &&rorzpx, &&rrazpx, // $70-$77
      &&seiimp, &&adcaby, &&nopimp, &&rraaby,
      &&nopabx, &&adcabx, &&rorabx, &&rraabx, // $78-$7F
      &&nopimm, &&staixx, &&nopimp, &&saxixx,
      &&styzpg, &&stazpg, &&stxzpg, &&saxzpg, // $80-$87
      &&deyimp, &&nopimp, &&txaimp, &&nopimp,
      &&styabs, &&staabs, &&stxabs, &&saxabs, // $88-$8F
      &&bccrel, &&staixy, &&nopimp, &&nopimp,
      &&styzpx, &&stazpx, &&stxzpy, &&saxzpy, // $90-$97
      &&tyaimp, &&staaby, &&txsimp, &&nopimp,
      &&nopimp, &&staabx, &&nopimp, &&nopimp, // $98-$9F
      &&ldyimm, &&ldaixx, &&ldximm, &&laxixx,
      &&ldyzpg, &&ldazpg, &&ldxzpg, &&laxzpg, // $A0-$A7
      &&tayimp, &&ldaimm, &&taximp, &&nopimp,
      &&ldyabs, &&ldaabs, &&ldxabs, &&laxabs, // $A8-$AF
      &&bcsrel, &&ldaixy, &&nopimp, &&laxixy,
      &&ldyzpx, &&ldazpx, &&ldxzpy, &&laxzpy, // $B0-$B7
      &&clvimp, &&ldaaby, &&tsximp, &&nopimp,
      &&ldyabx, &&ldaabx, &&ldxaby, &&laxaby, // $B8-$BF
      &&cpyimm, &&cmpixx, &&nopimp, &&dcpixx,
      &&cpyzpg, &&cmpzpg, &&deczpg, &&dcpzpg, // $C0-$C7
      &&inyimp, &&cmpimm, &&deximp, &&nopimp,
      &&cpyabs, &&cmpabs, &&decabs, &&dcpabs, // $C8-$CF
      &&bnerel, &&cmpixy, &&nopimp, &&dcpixy,
      &&nopzpx, &&cmpzpx, &&deczpx, &&dcpzpx, // $D0-$D7
      &&cldimp, &&cmpaby, &&nopimp, &&dcpaby,
      &&nopabx, &&cmpabx, &&decabx, &&dcpabx, // $D8-$DF
      &&cpximm, &&sbcixx, &&nopimp, &&isbixx,
      &&cpxzpg, &&sbczpg, &&inczpg, &&isbzpg, // $E0-$E7
      &&inximp, &&sbcimm, &&nopimp, &&sbcimm,
      &&cpxabs, &&sbcabs, &&incabs, &&isbabs, // $E8-$EF
      &&beqrel, &&sbcixy, &&nopimp, &&isbixy,
      &&nopzpx, &&sbczpx, &&inczpx, &&isbzpx, // $F0-$F7
      &&sedimp, &&sbcaby, &&nopimp, &&isbaby,
      &&nopabx, &&sbcabx, &&incabx, &&isbabx, // $F8-$FF
  };
#define DISPATCH()                                                             \
  do {                                                                         \
