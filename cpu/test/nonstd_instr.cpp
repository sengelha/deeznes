...
TEST(cpu_nonstd_instr, dcpabx)
{
    ...
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0x04, .regs.X = 1, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, dcpaby)
{
    ...
    uint8_t mem[0x1000] = {0xCC, 0x02};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0x04, .regs.Y = 1, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, isbabs)
{
    ...
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0xFF, .regs.P = 0x01, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, isbabx)
{
    ...
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0xFF, .regs.X = 1, .regs.P = 0x01, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, isbaby)
{
    ...
    uint8_t mem[0x1000] = {0xCC, 0xCC, 0x7F};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0xFF, .regs.Y = 1, .regs.P = 0x01, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, laxabs)
{
    ...
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0, .regs.X = 0, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, laxaby)
{
    ...
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0, .regs.X = 0, .regs.Y = 1, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, laxixx)
{
    ...
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0, .regs.X = 1, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, rlaabs)
{
    ...
    uint8_t mem[0x1000] = {0xCC, 0x7F};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0xEF, .regs.X = 1, .regs.P = 0, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, rlaaby)
{
    ...
    uint8_t mem[0x1000] = {0xCC, 0xCC, 0x7F};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0xEF, .regs.Y = 1, .regs.P = 0, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, rraabs)
{
    ...
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0x01, .regs.X = 1, .regs.P = 0, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, rraabx)
{
    ...
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0x01, .regs.Y = 1, .regs.P = 0, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, saxabs)
{
    ...
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0x7F, .regs.X = 0xF7, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, saxixx)
{
    ...
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0x8F, .regs.X = 0x01, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, saxzpy)
{
    ...
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0x7F, .regs.X = 0xF7, .regs.Y = 1, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, sloabs)
{
    ...
    uint8_t mem[0x1000] = {0xCC, 0x02};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0x40, .regs.X = 1, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, sloaby)
{
    ...
    uint8_t mem[0x1000] = {0xCC, 0xCC, 0x02};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0x40, .regs.Y = 1, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, sreabs)
{
    ...
    uint8_t mem[0x1000] = {0xCC, 0xFF};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0xF7, .regs.X = 1, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, sreaby)
{
    ...
    uint8_t mem[0x1000] = {0xCC, 0xCC, 0xFF};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0xF7, .regs.Y = 1, .cycles = 0};
    m6502 cpu(state, &c);
...
TEST(cpu_nonstd_instr, sreixx)
{
    ...
    uint8_t mem[0x1000] = {0xCC, 0xCC, 0x04, 0x00, 0xFF};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502_state state = {.regs.PC = 0xC000, .regs.A = 0xF7, .regs.X = 1, .regs.P = 0, .cycles = 0};
    m6502 cpu(state, &c);
