...
public:
    test_mem(uint8_t *instr_mem, size_t instr_mem_len)
        : instr_mem_(instr_mem), instr_mem_len_(instr_mem_len), ram_(nullptr), ram_len_(0) {}
    test_mem(uint8_t *instr_mem, size_t instr_mem_len, uint8_t *ram, size_t ram_len)
        : instr_mem_(instr_mem), instr_mem_len_(instr_mem_len), ram_(ram), ram_len_(ram_len) {}
