...
TEST(cpu_std_instr, adcabs) {
    uint8_t instr[] = {0x6D, 0x00, 0x00, 0x6D, 0x01, 0x00, 0x6D, 0x02,
                       0x00, 0x6D, 0x03, 0x00, 0x6D, 0x04, 0x00};
...
TEST(cpu_std_instr, adcabx) {
    uint8_t instr[] = {0x7D, 0x00, 0x00, 0x7D, 0x01, 0x00, 0x7D, 0x02, 0x00,
                       0x7D, 0x03, 0x00, 0x7D, 0x04, 0x00, 0x7D, 0xFF, 0x00};
...
TEST(cpu_std_instr, adcaby) {
    uint8_t instr[] = {0x79, 0x00, 0x00, 0x79, 0x01, 0x00, 0x79, 0x02, 0x00,
                       0x79, 0x03, 0x00, 0x79, 0x04, 0x00, 0x79, 0xFF, 0x00};
    uint8_t mem[0x1000] = {0xCC, 0x01, 0x01, 0xFF, 0xFF, 0x7F};
    mem[0x100] = 0x7F;
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
...
TEST(cpu_std_instr, adcimm) {
    uint8_t instr[] = {0x69, 0x01, 0x69, 0x01, 0x69,
                       0xFF, 0x69, 0xFF, 0x69, 0x7F};
...
TEST(cpu_std_instr, adcixx) {
    uint8_t instr[] = {0x61, 0x01, 0x61, 0x04, 0x61,
                       0x07, 0x61, 0x0A, 0x61, 0x0D};
    uint8_t mem[] = {0xCC, 0xCC, 0x04, 0x00, 0x01, 0x07, 0x00, 0x01, 0x0A,
                     0x00, 0xFF, 0x0D, 0x00, 0xFF, 0x10, 0x00, 0x7F};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
...
TEST(cpu_std_instr, adcixy) {
    uint8_t instr[] = {0x71, 0x00, 0x71, 0x03, 0x71, 0x06,
                       0x71, 0x09, 0x71, 0x0C, 0x71, 0x0F};
    uint8_t mem[0x1000] = {0x01, 0x00, 0x01, 0x04, 0x00, 0x01, 0x07, 0x00, 0xFF,
                           0x0A, 0x00, 0xFF, 0x0D, 0x00, 0x7F, 0xFF, 0x00};
    mem[0x100] = 0x7F;
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
...
TEST(cpu_std_instr, adczpg) {
    uint8_t instr[] = {0x65, 0x00, 0x65, 0x01, 0x65,
                       0x02, 0x65, 0x03, 0x65, 0x04};
...
TEST(cpu_std_instr, adczpx) {
    uint8_t instr[] = {0x75, 0x00, 0x75, 0x01, 0x75,
                       0x02, 0x75, 0x03, 0x75, 0x04};
...
TEST(cpu_std_instr, cmpabs) {
    uint8_t instr[] = {0xCD, 0x00, 0x00, 0xCD, 0x01, 0x00,
                       0xCD, 0x02, 0x00, 0xCD, 0x03, 0x00};
...
TEST(cpu_std_instr, cmpabx) {
    uint8_t instr[] = {0xDD, 0x00, 0x00, 0xDD, 0x01, 0x00, 0xDD, 0x02,
                       0x00, 0xDD, 0x03, 0x00, 0xDD, 0xFF, 0x00};
...
TEST(cpu_std_instr, cmpaby) {
    uint8_t instr[] = {0xD9, 0x00, 0x00, 0xD9, 0x01, 0x00, 0xD9, 0x02,
                       0x00, 0xD9, 0x03, 0x00, 0xD9, 0xFF, 0x00};
    uint8_t mem[0x1000] = {0xCC, 0x00, 0x10, 0x80, 0xFF};
    mem[0x100] = 0xFF;
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
...
TEST(cpu_std_instr, cmpixx) {
    ...
    uint8_t mem[] = {0xCC, 0xCC, 0x04, 0x00, 0x00, 0x07, 0x00,
                     0x10, 0x0A, 0x00, 0x80, 0x0D, 0x00, 0xFF};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
...
TEST(cpu_std_instr, cmpixy) {
    uint8_t instr[] = {0xD1, 0x00, 0xD1, 0x03, 0xD1,
                       0x06, 0xD1, 0x09, 0xD1, 0x0C};
    uint8_t mem[0x1000] = {0x01, 0x00, 0x00, 0x04, 0x00, 0x10, 0x07,
                           0x00, 0x80, 0x0A, 0x00, 0xFF, 0xFF, 0x00};
    mem[0x100] = 0xFF;
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
...
TEST(cpu_std_instr, cpxabs) {
    uint8_t instr[] = {0xEC, 0x00, 0x00, 0xEC, 0x01, 0x00,
                       0xEC, 0x02, 0x00, 0xEC, 0x03, 0x00};
    uint8_t mem[] = {0x00, 0x10, 0x80, 0xFF};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
...
TEST(cpu_std_instr, cpyabs) {
    uint8_t instr[] = {0xCC, 0x00, 0x00, 0xCC, 0x01, 0x00,
                       0xCC, 0x02, 0x00, 0xCC, 0x03, 0x00};
    uint8_t mem[] = {0x00, 0x10, 0x80, 0xFF};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
...
TEST(cpu_std_instr, eorabx) {
    uint8_t instr[] = {0x5D, 0x00, 0x00, 0x5D, 0x01, 0x00,
                       0x5D, 0x02, 0x00, 0x5D, 0xFF, 0x00};
...
TEST(cpu_std_instr, eoraby) {
    uint8_t instr[] = {0x59, 0x00, 0x00, 0x59, 0x01, 0x00,
                       0x59, 0x02, 0x00, 0x59, 0xFF, 0x00};
    uint8_t mem[0x1000] = {0xCC, 0xFF, 0xFF, 0xFF};
    mem[0x100] = 0xFF;
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
...
TEST(cpu_std_instr, eorixx) {
    ...
    uint8_t mem[] = {0xCC, 0xCC, 0x04, 0x00, 0xFF, 0x07,
                     0x00, 0xFF, 0x0A, 0x00, 0xFF};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
    m6502_state state = cpu.state();
    state.regs.PC = 0xC000;
...
TEST(cpu_std_instr, eorixy) {
    ...
    uint8_t mem[0x1000] = {0x01, 0x00, 0xFF, 0x04, 0x00, 0xFF,
                           0x07, 0x00, 0xFF, 0xFF, 0x00};
    mem[0x100] = 0xFF;
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
...
TEST(cpu_std_instr, ldaabx) {
    uint8_t instr[] = {0xBD, 0x00, 0x00, 0xBD, 0x01, 0x00,
                       0xBD, 0x02, 0x00, 0xBD, 0xFF, 0x00};
    uint8_t mem[0x101];
...
TEST(cpu_std_instr, ldaaby) {
    uint8_t instr[] = {0xB9, 0x00, 0x00, 0xB9, 0x01, 0x00,
                       0xB9, 0x02, 0x00, 0xB9, 0xFF, 0x00};
    uint8_t mem[0x101];
    memset(mem, 0xCC, ARRAYSIZE(mem));
    mem[0x0001] = 0x00;
    mem[0x0002] = 0x45;
...
TEST(cpu_std_instr, ldaixx) {
    uint8_t instr[] = {0xA1, 0x01, 0xA1, 0x03, 0xA1,
                       0x06, 0xA1, 0xFE, 0xA1, 0xFF};
    uint8_t mem[0x1000] = {0x01, 0xCC, 0x03, 0x00, 0x06,
                           0x00, 0x45, 0x09, 0x00, 0xFF};
    mem[0x80] = 0x00;
    mem[0x81] = 0x02;
    mem[0x200] = 0x5A;
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
...
TEST(cpu_std_instr, ldxaby) {
    uint8_t instr[] = {0xBE, 0x00, 0x00, 0xBE, 0x01, 0x00,
                       0xBE, 0x02, 0x00, 0xBE, 0xFF, 0x00};
    uint8_t mem[0x101];
    memset(mem, 0xCC, ARRAYSIZE(mem));
    mem[0x0001] = 0x00;
    mem[0x0002] = 0x45;
...
TEST(cpu_std_instr, ldyabx) {
    uint8_t instr[] = {0xBC, 0x00, 0x00, 0xBC, 0x01, 0x00,
                       0xBC, 0x02, 0x00, 0xBC, 0xFF, 0x00};
    uint8_t mem[0x101];
    memset(mem, 0xCC, sizeof(mem));
    mem[1] = 0x00;
    mem[2] = 0x45;
...
TEST(cpu_std_instr, oraabx) {
    uint8_t instr[] = {0x1D, 0x00, 0x00, 0x1D, 0x01, 0x00,
                       0x1D, 0x02, 0x00, 0x1D, 0xFF, 0x00};
...
TEST(cpu_std_instr, oraaby) {
    uint8_t instr[] = {0x19, 0x00, 0x00, 0x19, 0x01, 0x00,
                       0x19, 0x02, 0x00, 0x19, 0xFF, 0x00};
    uint8_t mem[0x1000] = {0xCC, 0x00, 0x0F, 0xF0};
    mem[0x100] = 0x07;
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
...
TEST(cpu_std_instr, oraixx) {
    ...
    uint8_t mem[] = {0xCC, 0xCC, 0x04, 0x00, 0x00, 0x07,
                     0x00, 0x0F, 0x0A, 0x00, 0xF0};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
    m6502_state state = cpu.state();
    state.regs.PC = 0xC000;
...
TEST(cpu_std_instr, oraixy) {
    ...
    uint8_t mem[0x1000] = {0x01, 0x00, 0x00, 0x04, 0x00, 0x0F,
...
TEST(cpu_std_instr, sbcabx) {
    uint8_t instr[] = {0xFD, 0x00, 0x00, 0xFD, 0x01, 0x00,
                       0xFD, 0x02, 0x00, 0xFD, 0xFF, 0x00};
...
TEST(cpu_std_instr, sbcaby) {
    uint8_t instr[] = {0xF9, 0x00, 0x00, 0xF9, 0x01, 0x00,
                       0xF9, 0x02, 0x00, 0xF9, 0xFF, 0x00};
    uint8_t mem[0x1000] = {0xCC, 0x01, 0x01, 0x01};
    mem[0x100] = 0x01;
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
...
TEST(cpu_std_instr, sbcixx) {
    ...
    uint8_t mem[] = {0xCC, 0xCC, 0x04, 0x00, 0x01, 0x07,
                     0x00, 0x01, 0x0A, 0x00, 0x01};
    test_mem c(instr, ARRAYSIZE(instr), mem, ARRAYSIZE(mem));
    m6502 cpu(&c);
...
TEST(cpu_std_instr, sbcixy) {
    ...
    uint8_t mem[0x1000] = {0x01, 0x00, 0x01, 0x04, 0x00, 0x01,
