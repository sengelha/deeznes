cc_library(
    ...
    include_prefix = "FLAC",
    strip_include_prefix = "extlibs/headers/FLAC",
)

cc_import(
    name = "freetype2_import",
    static_library = "extlibs/libs-msvc/x64/freetype.lib",
)
...
cc_library(
    ...
    hdrs = glob([
        ...
        "extlibs/headers/freetype2/config/*.h",
    ]),
    strip_include_prefix = "extlibs/headers/freetype2",
    deps = [":freetype2_import"],
)
...
cc_library(
    ...
    include_prefix = "ogg",
    strip_include_prefix = "extlibs/headers/ogg",
)
...
cc_library(
    ...
    strip_include_prefix = "extlibs/headers/AL",
)
...
cc_library(
    ...
    include_prefix = "vorbis",
    strip_include_prefix = "extlibs/headers/vorbis",
)
...
cc_library(
    ...
    copts = select({
        "@platforms//os:windows": ["/Iexternal/sfml/src"],
        "@platforms//os:linux": ["-Iexternal/sfml/src"],
    }),
    defines = [
        "SFML_STATIC",
    ],
